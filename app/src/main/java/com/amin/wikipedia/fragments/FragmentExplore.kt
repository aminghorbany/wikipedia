...
class FragmentExplore : Fragment() , OnItemCliCKEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listExplore = arrayListOf(
            // Explore Section =>
            ItemPostDC(
                "https://dunijet.ir/YaghootAndroidFiles/Wikipedia/jamiroquai.jpg",
                "Jamiroquai",
                "British acid jazz band",
                "rock, disco, electronic and Latin music genres. Lyrically, the group has addressed social and environmental justice. Kay has remained as the only original member through several line-up changes.\n" +
        ...
        val myAdapter = ExploreAdapter(listExplore , this)
    ...
    override fun onItemClick(itemPostDC: ItemPostDC) {
        val intent = Intent(activity , DetailActivity::class.java)
        intent.putExtra(AppCons.SEND_DATA , itemPostDC)
