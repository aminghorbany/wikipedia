...
import com.amin.wikipedia.adapter.TrendAdapter
import com.amin.wikipedia.databinding.FragmentExploreBinding
import com.amin.wikipedia.databinding.FragmentTrendBinding
import com.amin.wikipedia.dataclass.ItemPostDC

class FragmentTrend : Fragment() , OnItemCliCKEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listTrend = arrayListOf<ItemPostDC> (
        ...
        val myTrendAdapter = TrendAdapter(listTrend , this)
        binding.recyclerTrend.adapter = myTrendAdapter
